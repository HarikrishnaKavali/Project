...
public class  UsersUpdateCheckAction extends ActionSupport implements ServletRequestAware {
...
public String execute()
{
	...
	UsersUpdateDao urd = (UsersUpdateDao)context.getBean("UsersUpdateDao");
	...
	Integer count=urd.userupdate(urb);
	System.out.println(count);
	if(count !=0)
	{
		request.setAttribute("result","your details are successfully updated");
	return "success";
	}
	else
	{
	request.setAttribute("result","your details are updatedation failed");
	return "login";
	}
}

...
<body>
	<center>
		<s:form action="/usersdelete" method="post" validate="true">
			<table align="center">
				<s:head />
...
<tr align="left"><td><s:url id="usersdelete" action="userdelete">
					<s:param name="username"><%=st.getUsername()%></s:param>
					</s:url>
					<s:a href="%{usersdelete}" >usersdelete</s:a></td></tr>
</table>
